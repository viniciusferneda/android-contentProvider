package com.vferneda.applicationcontentprovider.database
...
class NotesProvider : ContentProvider() {
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<String>?): Int {
        if (mUriMatcher.match(uri) == NOTES_BY_ID) {
            ...
            val linesAffect =
                db.delete(NotesDatabaseHelper.TABLE_NOTES, "$_ID", arrayOf(uri.lastPathSegment))
            db.close()
    ...
    companion object {
        const val AUTHORITY = "com.vferneda.applicationcontentprovider.provider"
